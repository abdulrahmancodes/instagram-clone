...
const UserSkeleton = () => {
    ...
    return (
        <div className="flex relative pt-4 lg:pt-20 pb-36 lg:pb-12 lg:w-935 mx-auto pl-4 lg:pl-16">
            {isMobile ? (
                <Skeleton circle={true} width={80} height={80} className="mr-8" />
            ) : (
            ...
            <div className="flex flex-col">
                ...
                <Skeleton
                    ...
                    className={`${isMobile && "absolute top-16"}`}
                />
            </div>
        </div>
    );
                    ...
                    <div className="flex justify-evenly w-screen">
                        <Link to={url}>
                            <span
                                ...
                                className={`flex ${isPostsClicked && "md:border-t-1"
                                    } border-black items-center p-4 mr-4`}
                            >
                                <svg
                                    aria-label="Posts"
                                    fill={`${isPostsClicked
                                ...
                                <span
                                    className={`ml-2 ${isPostsClicked ? "text-black" : "text-gray-400"
                                        } hidden md:block text-sm font-normal`}
                                >
                                    POSTS
                </span>
                            </span>
                        ...
                        {userObj && loggedInUser.uid == userObj.userId && (
                            <Link to={`${url}/saved`}>
                                <span
                                    ...
                                    className={`flex ${isSavedClicked && "md:border-t-1"
                                        } border-black items-center p-4 ml-4`}
                                >
                                    <svg
                                        aria-label="Saved"
                                        fill={`${isSavedClicked
                                    ...
                                    <span
                                        className={`ml-2 ${isSavedClicked ? "text-black" : "text-gray-400"
                                            } hidden md:block text-sm font-normal`}
                                    >
                                        SAVED
                  </span>
