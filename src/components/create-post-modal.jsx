...
export default function CreatePostModal( {setIsOpen, setIsLoading} ) {
    ...
    return (
        <div className="flex md:max-w-614 flex-col absolute top-20 rounded-md left-1/4 z-30 bg-white font-roboto" >
            <div className="flex w-full relative py-2 justify-center border-b-1 border-gray-300 ">
                <h3 className="font-semibold">New Post</h3>
                <span className="absolute right-4 top-2 hover:bg-gray-300 rounded-full cursor-pointer" onClick={() => setIsOpen(false) } >
                    <CloseIcon />
                </span>
            </div>
