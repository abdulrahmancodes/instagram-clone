...
export default function CreatePostModal({ setIsOpen, setIsLoading }) {
    ...
    return (
        <div className="absolute left-1/2">
            <div className="flex md:w-614 flex-col relative top-20 rounded-md -left-1/2 z-30 bg-white font-roboto" >
                ...
                <div className="w-full h-60 rounded px-4 overflow-y-scroll mb-4">
                    {imgSrc ? <img src={imgSrc} alt="" className="w-full" /> : <Skeleton width={582} height={200} />}
                </div>
