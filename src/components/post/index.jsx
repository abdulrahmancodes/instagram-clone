...
export default function Post({ data: { imageSrc, likes, isLiked, isSaved, userId, caption, comments, dateCreated, username, docId } }) {
    return (
        <div className="flex flex-col bg-white mb-8 border-1 rounded-sm border-gray-300 " >
            <Header username={username} postId={docId} />
            { imageSrc ? <Image imageSrc={imageSrc} caption={caption} /> : <Skeleton width={611} height={600} /> }
            <Actions likes={likes} isLiked={isLiked} postId={docId} isSaved={isSaved} />
