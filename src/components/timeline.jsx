...
export default function Timeline() {
    ...
    if (timelinePosts === undefined) {
        ...
        content = timelinePosts.map((post) => (
            <Post key={post?.docId} data={post} />
        ));
    }
            ...
            {!isMobile && (
                <>
                    <label
                        ...
                        className="bg-blue justify-center hidden sm:flex font-semibold text-white items-center py-2 w-full rounded-sm cursor-pointer mb-4"
                    >
